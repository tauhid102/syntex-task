...
const Lunch = () => {
    ...
    const restIteam = contents.filter(iteam => iteam.categories === 'lunch');
    ...
    const handleInfo = (e) => {
        // data wast lost without using preventDefalut
        e.preventDefault();
        const purchased = {
            // using three dot we are spread the confirmPurchased object
            ...confirmPurchased,
            status,
            itemName: iteamName,
